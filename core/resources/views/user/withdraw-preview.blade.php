                    ...
                    <div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label style="margin-top: 5px;font-size: 14px;" class="col-sm-2 bold uppercase text-right  control-label">Bitcoin Address : </label>

                                        <div class="col-sm-8">

                                                        <textarea name="send_details" id="" rows="4"
                                                                  class="form-control bold input-lg" placeholder="Enter Bitcoin Address" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>
